...
class Monitor extends Component {
    ...
    constructor(props) {
        ...
        this.calcelOrder = this.calcelOrder.bind(this);
            ...
            <div className="container-fluid">
                ...
                <div className="row">
                    ...
                    <div className="col-md-3">
                        <Calculator totalPrice={this.state.totalPrice} orders={this.state.orders} onDelOrder={this.delOrder} onCalcelOrder={this.calcelOrder} onConfirmOrder={this.confirmOrder} />
                    </div>
                </div>
            </div>
        );
